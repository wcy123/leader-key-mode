...
(define-key leader-key-mode-mark-active-keymap (kbd "p") 'previous-line)
...
(define-key leader-key-mode-mark-active-keymap (kbd "s")  #'(lambda()
                                                              ...
                                                              (leader-key-mode-select-thing-at-point
                                                               'sexp)))
(define-key leader-key-mode-mark-active-keymap (kbd "l")  #'(lambda()
                                                              (interactive)
                                                              (leader-key-mode-select-thing-at-point
                                                               'line)))
(define-key leader-key-mode-mark-active-keymap (kbd "P")  #'(lambda()
                                                              (interactive)
                                                              (leader-key-mode-select-thing-at-point
                                                               'sentence)))
...
(define-key leader-key-mode-keymap (kbd "=") 'leader-key-mode-save-or-jump-to-point)
